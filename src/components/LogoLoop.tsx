...
export const LogoLoop = () => {
  ...
  const logos: { name: string; logo: React.ReactNode }[] = [
    ...
    },
    {
      name: "Vue.js",
      logo: (
        <svg viewBox="0 0 448 512" className="w-full h-full" fill="#4FC08D">
          <path d="M356.9 64.3l-76.9 0-56 88.6-48-88.6-176 0 224 383.7 224-383.7-91.1 0zM55.7 96.3l53.8 0 114.5 198.2 114.4-198.2 53.8 0-168.2 288.2-168.3-288.2z"/>
        </svg>
      )
    },
    {
